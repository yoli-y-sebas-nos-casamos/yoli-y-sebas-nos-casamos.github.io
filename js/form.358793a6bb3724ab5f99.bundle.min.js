...
"use strict";
(self.webpackChunkelementor_pro = self.webpackChunkelementor_pro || []).push([[680], {
    2679: (e,t)=>{
        ...
        var s = elementorModules.frontend.handlers.Base.extend({
            ...
            validateFileSize(e) {
                ...
                Array.prototype.slice.call(s).forEach((e=>{
                    r < e.size && (t.parent().addClass("elementor-error").append('<span class="elementor-message elementor-message-danger elementor-help-inline elementor-form-help-inline" role="alert">' + i + "</span>").find(":input").attr("aria-invalid", "true"),
    ...
    8503: (e,t)=>{
        ...
        class FormSteps extends elementorModules.frontend.handlers.Base {
            ...
            getStepIndicatorElement(e, t) {
                ...
                return r.step_type.includes("icon") && a.append(this.getStepIconElement(e)),
                r.step_type.includes("number") && a.append(this.getStepNumberElement(t)),
                r.step_type.includes("text") && a.append(this.getStepLabelElement(e.label)),
                a
            }
            ...
            injectButtonsToSteps() {
                ...
                this.elements.$stepWrapper.each(((t,s)=>{
                    ...
                    n = t === e - 1 ? this.getSubmitButton() : this.getStepButton("next", t)) : n = this.getStepButton("next", t),
                    i.append(n),
                    r.append(i)
                }
                ))
            ...
            extractResponsiveSizeFromSubmitWrapper() {
                let e = [];
                this.elements.$submitWrapper.removeClass(((t,s)=>(e = s.match(/elementor-(sm|md)-[0-9]+/g)?.join(" "),
                e))),
            ...
            getButton(e, t) {
                const {classes: s} = this.getSettings()
                  , r = this.elements.$submitButton.attr("class").match(/elementor-size-([^\W\d]+)/g)
            ...
            updateStepsShape() {
                ...
                let a = "";
                e.step_type.includes("icon") ? a = "icon" : e.step_type.includes("number") && (a = "number"),
                this.elements.$indicators.children(t.indicator + "__" + a).removeClass(i).addClass(n),
    ...
    2108: (e,t)=>{
        ...
        class Recaptcha extends elementorModules.frontend.handlers.Base {
            ...
            addRecaptcha() {
                ...
                t ? this.elements.$recaptcha.data("widgetId", r) : (s.push(r),
                this.elements.$submit.on("click", (e=>this.onV3FormSubmit(e, r))))
            }
            onV3FormSubmit(e, t) {
                e.preventDefault(),
