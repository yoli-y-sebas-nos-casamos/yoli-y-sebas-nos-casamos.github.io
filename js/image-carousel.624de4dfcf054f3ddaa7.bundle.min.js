...
"use strict";
(self.webpackChunkelementor = self.webpackChunkelementor || []).push([[268], {
    5914: (e,t)=>{
        ...
        class ImageCarousel extends elementorModules.frontend.handlers.SwiperBase {
            ...
            getSwiperSettings() {
                ...
                Object.keys(n).reverse().forEach((t=>{
                    ...
                    e.image_spacing_custom && (a.breakpoints[n[t].value].spaceBetween = this.getSpaceBetween(t)),
            ...
            updateSpaceBetween(e) {
                ...
                "desktop" !== s && (this.swiper.params.breakpoints[elementorFrontend.config.responsive.activeBreakpoints[s].value].spaceBetween = n),
