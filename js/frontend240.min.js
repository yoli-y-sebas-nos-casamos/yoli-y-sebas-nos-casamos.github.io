...
(self.webpackChunkelementor = self.webpackChunkelementor || []).push([[819], {
    ...
    6866: (e,t)=>{
        ...
        const n = elementorFrontendConfig.environmentMode.isScriptDebug ? "" : ".min"
          , s = elementorFrontendConfig.experimentalFeatures.e_swiper_latest ? `${elementorFrontendConfig.urls.assets}js/swiper.min.js` : `${elementorFrontendConfig.urls.assets}js/swiper.min.js`;
        AssetsLoader.assets = {
            script: {
                dialog: {
                    src: `${elementorFrontendConfig.urls.assets}js/dialog ${n}.js?ver=4.9.0`
                },
                "share-link": {
                    src: `${elementorFrontendConfig.urls.assets}js/share-link ${n}.js?ver=${elementorFrontendConfig.version}`
                },
                swiper: {
                    src: s
                }
