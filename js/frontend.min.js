...
!function() {
    ...
    function s(e) {
        ...
        if ("dropdown" === c && (document.getElementById("ast-mobile-popup").classList.remove("active", "show"),
        m("updateHeader")),
        "off-canvas" === c)
    ...
    function n(e) {
        ...
        if (void 0 === e && null !== i)
            if (u = i.querySelector("#ast-mobile-header"))
                e = u.dataset.type;
            else {
        ...
        if ("off-canvas" === e) {
            ...
            link = 0,
            len = popupLinks.length; link < len; link++)
                null !== popupLinks[link].getAttribute("href") && popupLinks[link].getAttribute("href").startsWith("#") && (!popupLinks[link].parentElement.classList.contains("menu-item-has-children") || popupLinks[link].parentElement.classList.contains("menu-item-has-children") && document.querySelector("header.site-header").classList.contains("ast-builder-menu-toggle-icon")) && (popupLinks[link].addEventListener("click", g, !0),
                popupLinks[link].headerType = "off-canvas");
            AstraToggleSetup()
        } else if ("dropdown" === e) {
            s = document.querySelector(".ast-mobile-header-content") || !1,
            n = document.querySelector(".ast-desktop-header-content") || !1;
            if (s) {
                var l = s.getElementsByTagName("a");
                for (link = 0,
                len = l.length; link < len; link++)
                    null !== l[link].getAttribute("href") && l[link].getAttribute("href").startsWith("#") && (!l[link].parentElement.classList.contains("menu-item-has-children") || l[link].parentElement.classList.contains("menu-item-has-children") && document.querySelector("header.site-header").classList.contains("ast-builder-menu-toggle-icon")) && (l[link].addEventListener("click", g, !0),
            ...
            if (n) {
                ...
                len = r.length; link < len; link++)
                    r[link].addEventListener("click", g, !0),
    ...
    "" !== (u = null != i ? i.querySelector("#ast-mobile-header") : u) && null !== u && (c = u.dataset.type),
    document.addEventListener("astMobileHeaderTypeChange", s, !1),
    popupTriggerClick = function(e) {
        ...
        d.classList.contains("ast-main-header-nav-open") || "mobile" === e || d.classList.add("ast-main-header-nav-open"),
    ...
    window.addEventListener("resize", function() {
        ...
        window.visualViewport.width !== o && (t && null === n && t.click(),
        document.body.classList.remove("ast-main-header-nav-open", "ast-popup-nav-open"),
        e && null == n && e.click()),
        p(),
        AstraToggleSetup())
    ...
    document.addEventListener("DOMContentLoaded", function() {
        if (AstraToggleSetup(),
        null !== (e = d.classList.contains("ast-header-break-point") ? document.getElementById("ast-mobile-header") : document.getElementById("ast-desktop-header"))) {
            ...
            if (t && e) {
                ...
                if (void 0 !== a || void 0 !== (a = e.getElementsByTagName("a")[0])) {
                    ...
                    if (void 0 !== n) {
                        ...
                        "off-canvas" === c && (document.getElementById("menu-toggle-close").onclick = function() {
    ...
    for (var e, t, a, p = function() {
        var e = d.style.overflow
          , t = (d.style.overflow = "hidden",
        document.documentElement.clientWidth);
        if (d.style.overflow = e,
        ...
        void 0 !== a && (e = document.getElementById("ast-hb-login-close"),
    ...
    AstraToggleSetup = function() {
        ...
        if ("undefined" != typeof astraAddon)
            astraToggleSetupPro(c, d, r);
        else if (e = "off-canvas" === c || "full-width" === c ? document.querySelectorAll("#ast-mobile-popup, #ast-mobile-header") : document.querySelectorAll("#ast-mobile-header"),
        0 < (t = document.querySelectorAll("#ast-mobile-header .main-header-menu-toggle")).length)
            for (var a = 0; a < t.length; a++)
                if (t[a].setAttribute("data-index", a),
                r[a] || (r[a] = t[a],
    ...
    astraNavMenuToggle = function(e) {
        if ("undefined" != typeof astraAddon)
            ...
            d.classList.add("ast-main-header-nav-open")) : (e[t].style.display = "",
            d.classList.remove("ast-main-header-nav-open")))
        }
    }
    ,
    ...
    /trident/i.test(a[1]) ? e = /\brv[ :]+(\d+)/g.exec(t) || [] : "Chrome" === a[1] && null != (e = t.match(/\bOPR|Edge\/(\d+)/)) || (a = a[2] ? [a[1], a[2]] : [navigator.appName, navigator.appVersion, "-?"],
    null != (e = t.match(/version\/(\d+)/i)) && a.splice(1, 1, e[1]),
    "Safari" === a[0] && a[1] < 11 && document.body.classList.add("ast-safari-browser-less-than-11")),
    document.getElementsByClassName("astra-search-icon")), f = 0; f < h.length; f++)
